...
css_color_names = \
    {"aliceblue": True, "antiquewhite": True, "aqua": True, "aquamarine": True, "azure": True, "beige": True,
     "bisque": True, "black": True, "blanchedalmond": True, "blue": True, "blueviolet": True, "brown": True,
     "burlywood": True, "cadetblue": True, "chartreuse": True, "chocolate": True, "coral": True, "cornflowerblue": True,
     "cornsilk": True, "crimson": True, "cyan": True, "darkblue": True, "darkcyan": True, "darkgoldenrod": True,
     "darkgray": True, "darkgrey": True, "darkgreen": True, "darkkhaki": True, "darkmagenta": True,
     "darkolivegreen": True, "darkorange": True, "darkorchid": True, "darkred": True, "darksalmon": True,
     "darkseagreen": True, "darkslateblue": True, "darkslategray": True, "darkslategrey": True, "darkturquoise": True,
     "darkviolet": True, "deeppink": True, "deepskyblue": True, "dimgray": True, "dimgrey": True, "dodgerblue": True,
     "firebrick": True, "floralwhite": True, "forestgreen": True, "fuchsia": True, "gainsboro": True,
     "ghostwhite": True, "gold": True, "goldenrod": True, "gray": True, "grey": True, "green": True,
     "greenyellow": True, "honeydew": True, "hotpink": True, "indianred": True, "indigo": True, "ivory": True,
     "khaki": True, "lavender": True, "lavenderblush": True, "lawngreen": True, "lemonchiffon": True, "lightblue": True,
     "lightcoral": True, "lightcyan": True, "lightgoldenrodyellow": True, "lightgray": True, "lightgrey": True,
     "lightgreen": True, "lightpink": True, "lightsalmon": True, "lightseagreen": True, "lightskyblue": True,
     "lightslategray": True, "lightslategrey": True, "lightsteelblue": True, "lightyellow": True, "lime": True,
     "limegreen": True, "linen": True, "magenta": True, "maroon": True, "mediumaquamarine": True, "mediumblue": True,
     ...
     "mintcream": True, "mistyrose": True, "moccasin": True, "navajowhite": True, "navy": True, "oldlace": True,
     "olive": True, "olivedrab": True, "orange": True, "orangered": True, "orchid": True, "palegoldenrod": True,
     "palegreen": True, "paleturquoise": True, "palevioletred": True, "papayawhip": True, "peachpuff": True,
     "peru": True, "pink": True, "plum": True, "powderblue": True, "purple": True, "red": True, "rosybrown": True,
     "royalblue": True, "saddlebrown": True, "salmon": True, "sandybrown": True, "seagreen": True, "seashell": True,
     "sienna": True, "silver": True, "skyblue": True, "slateblue": True, "slategray": True, "slategrey": True,
     "snow": True, "springgreen": True, "steelblue": True, "tan": True, "teal": True, "thistle": True, "tomato": True,
     "turquoise": True, "violet": True, "wheat": True, "white": True, "whitesmoke": True, "yellow": True,
     "yellowgreen": True};
    ...
    if arc_type == "a":
        for i in range(len(arc_indices) - 1):
            ...
            if len(arc_numbers) < 7:
                continue
            arcs.append({'rx': convert_str_to_float(arc_numbers[0]), 'ry': convert_str_to_float(arc_numbers[1]),
                         'x': convert_str_to_float(arc_numbers[5]), 'y': convert_str_to_float(arc_numbers[6])})
        ...
        for i in range(len(arc_indices) - 1):
            ...
            if len(arc_numbers) != 4:
                continue
            arcs.append({'x1': convert_str_to_float(arc_numbers[0]), 'y1': convert_str_to_float(arc_numbers[1]),
                         'x': convert_str_to_float(arc_numbers[2]), 'y': convert_str_to_float(arc_numbers[3])})
        arc_numbers = get_numbers_from_path(lower_path[arc_indices[len(arc_indices) - 1] + 1:])
        if len(arc_numbers) == 4:
            arcs.append({'x1': convert_str_to_float(arc_numbers[0]), 'y1': convert_str_to_float(arc_numbers[1]),
                         'x': convert_str_to_float(arc_numbers[2]), 'y': convert_str_to_float(arc_numbers[3])})
...
def is_line_vertical_or_horizontal(line):
    ...
    if (vertical_difference == 0 and horizontal_difference > 0) or (
            horizontal_difference == 0 and vertical_difference > 0):
        return True
    return False
